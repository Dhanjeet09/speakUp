...
export const INTEREST_MATCH_TIMEOUT_MS = 20000;
export const LEVEL_EXPAND_TIMEOUT_MS = 45000;
...
export function getTodaysTopic(topics: string[] = DAILY_TOPICS): string {
